...
class BuildTest {
    ...
    @Test
    void buildFreeSpace() {
        Build build = new Build(BuildingType.ENERGY, MyLane.DEFENDING, TheirLane.ATTACKING);
    ...
    void buildNonFreeSpace() {
        Build build = new Build(BuildingType.ATTACK, MyLane.DEFENDING, TheirLane.ATTACKING);
    ...
    void buildMyLaneAttacking() {
        Build build = new Build(BuildingType.ATTACK, MyLane.ATTACKING, TheirLane.ATTACKING);
    ...
    void buildMyLaneOnlyEnergy() {
        Build build = new Build(BuildingType.ATTACK, MyLane.ONLY_ENERGY, TheirLane.ATTACKING);
    ...
    void buildMyLaneOnlyAttacking() {
        Build build = new Build(BuildingType.ATTACK, MyLane.ONLY_ATTACKING, TheirLane.ATTACKING);
    ...
    void buildTheirLaneEmpty() {
        Build build = new Build(BuildingType.ATTACK, MyLane.ONLY_ATTACKING, TheirLane.EMPTY);
    ...
    void buildTheirLaneOnlyEnergy() {
        Build build = new Build(BuildingType.ATTACK, MyLane.ONLY_ATTACKING, TheirLane.ONLY_ENERGY);
    ...
    void buildTheirLaneNotAttacking() {
        Build build = new Build(BuildingType.ATTACK, MyLane.ONLY_ATTACKING, TheirLane.NOT_ATTACKING);
    ...
    void buildTheirLaneNotDefending() {
        ...
        Build build = new Build(BuildingType.ATTACK, MyLane.ONLY_ATTACKING, TheirLane.NOT_DEFENDING);
